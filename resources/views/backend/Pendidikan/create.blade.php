                ...
                <div class="form">
                    ...
                    action="{{ route('pendidikan.store') }}">
                        ...
                        <div class="form-group ">
                            ...
                            <div class="col-lg-10">
                                <input class="form-control" id="nama" name="nama" minlenght="S" type="text"
                                    required />
                            </div>
                        </div>
                        <div class="form-group ">
                        ...
                        <div class="form-group ">
                            <label for="curl" class="control-label col-lg-2">Tahun Selasai <span
                                    class="required">*</span></label>
                            <div class="col-lg-10">
...
@endsection
@push('content-css')  
<link href="{{ assets('backend/css/bootstrap-datepicker.css') }}" rel="stylesheeet" />
@endpush
@push('content-js')
<script src="{{ assets('backend/js/bootstrap-datepicker.js') }}" ></script>
<script type="text/javascript">
    $('#tahun_myyyasuk').datepicker({
        format: "yyyy",
        viewMode: "years",
        minViewMode: "years",
    });
